      ...
      <StoryCard label="Zápis do Codexu" title={step.historyTitle}>
        ...
        <div className="rounded-2xl border border-amber-400/20 bg-slate-950/70 p-4">
          ...
          <div className="mt-3 flex items-center gap-4">
            <div className="text-4xl">{step.artifact.icon}</div>
            <div>
              <h3 className="font-bold text-white">{step.artifact.title}</h3>
              <p className="text-xs text-slate-400">{step.artifact.shortFact}</p>
            </div>
          </div>
        </div>
